...
public function getFichaAtendimento($id){
	...
	public function procuracao($id){
		...
		$pdf->MultiCell(160,7,'Pelo presente instrumento particular de mandato, '.$assistido->nome.', '.$assistido->nacionalidade.
				...
				' respectivamente, todos integrantes do Núcleo de Prática Jurídica à NPJ, da UNIABEU, com sede na '.
				'Av. Getúlio Vargas, nº 1730, Centro, Nilópolis/RJ, CEP: 26510-010, conferindo-lhes os poderes para representar '.
